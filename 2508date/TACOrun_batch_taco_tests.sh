...
BASE_OUTPUT_DIR="output/batch_TACO_${TIMESTAMP}"
mkdir -p "$BASE_OUTPUT_DIR"

# Create symlink to latest results
ln -sfn "batch_TACO_${TIMESTAMP}" "output/batch_TACO_latest"
...
cp src/parameters.hpp src/parameters.hpp.backup_batch
...
compile_config() {
    ...
    # Start from backup
    cp src/parameters.hpp.backup_batch "$COMPILE_DIR/src/parameters.hpp"
...
mv src/parameters.hpp.backup_batch src/parameters.hpp
